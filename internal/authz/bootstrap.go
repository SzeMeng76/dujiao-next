	...
	return []RoleSeed{
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/orders/:id/manual-confirm-payment", Action: "POST"},
				{Object: "/admin/order-refunds", Action: "GET"},
				{Object: "/admin/order-refunds/:id", Action: "GET"},
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/settings/translation/jobs", Action: "POST"},
				{Object: "/admin/settings/translation/jobs/:id", Action: "GET"},
