...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.not_placeholder_account":                  "当前账号无需升级",
		"error.upgrade_account_failed":                   "账号升级失败",
		...
		"error.translation_not_configured":               "AI 翻译未配置或未启用，请先在设置中填写 API Key 并开启",
		"error.translation_failed":                       "调用翻译服务失败",
		...
		"error.order_manual_confirm_not_allowed":         "当前订单状态不允许人工确认支付",
		"error.manual_confirm_payment_not_found":         "该订单没有可人工确认的支付记录",
		"error.manual_confirm_remark_required":           "请填写人工确认备注",
		...
		"error.payment_amount_too_small":                 "支付金额低于该渠道最小限额",
		"error.payment_amount_too_large":                 "支付金额超过该渠道最大限额",
	...
	LocaleTW: {
		...
		"error.not_placeholder_account":                  "當前帳號無需升級",
		"error.upgrade_account_failed":                   "帳號升級失敗",
		...
		"error.translation_not_configured":               "AI 翻譯未配置或未啟用，請先在設定中填寫 API Key 並開啟",
		"error.translation_failed":                       "呼叫翻譯服務失敗",
		...
		"error.order_manual_confirm_not_allowed":         "當前訂單狀態不允許人工確認支付",
		"error.manual_confirm_payment_not_found":         "該訂單沒有可人工確認的支付記錄",
		"error.manual_confirm_remark_required":           "請填寫人工確認備註",
		...
		"error.payment_amount_too_small":                 "支付金額低於該渠道最小限額",
		"error.payment_amount_too_large":                 "支付金額超過該渠道最大限額",
	...
	LocaleEN: {
		...
		"error.not_placeholder_account":                  "This account does not need to be upgraded",
		"error.upgrade_account_failed":                   "Failed to upgrade account",
		...
		"error.translation_not_configured":               "AI translation is not configured or enabled; please set an API key and enable it first",
		"error.translation_failed":                       "Failed to call the translation service",
		...
		"error.order_manual_confirm_not_allowed":         "Order status does not allow manual payment confirmation",
		"error.manual_confirm_payment_not_found":         "No confirmable payment record exists for this order",
		"error.manual_confirm_remark_required":           "A remark is required to manually confirm payment",
		...
		"error.payment_amount_too_small":                 "Payment amount is below this channel's minimum limit",
		"error.payment_amount_too_large":                 "Payment amount exceeds this channel's maximum limit",
