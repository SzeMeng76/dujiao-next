...
func (a callbackServiceTestAdapter) HandleSyncCallback(channel *models.PaymentChannel, form map[string][]string, body []byte) (*models.Payment, error) {
	return a.payments.HandleSyncCallback(channel, form, body)
}

func (a callbackServiceTestAdapter) HandleWechatWebhook(input paymentcallback.WechatWebhookInput) (*models.Payment, string, error) {
	return a.payments.HandleWechatWebhook(service.WebhookCallbackInput{
