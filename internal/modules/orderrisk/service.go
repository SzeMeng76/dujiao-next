...
// NewService 创建风控服务。
func NewService(settingService SettingReader, orderRepo PendingOrderCounter) *Service {
	return &Service{
...
func (s *Service) CheckOrderAllowed(input CheckInput) error {
