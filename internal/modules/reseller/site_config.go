...
func NewSiteConfigService(repo SiteConfigRepository) *SiteConfigService {
...
// 通过 Unwrap 兼容既有的 errors.Is(err, ErrSiteConfigInvalid) 判断。
...
func (e *ResellerSiteConfigFieldError) Unwrap() error { return ErrSiteConfigInvalid }
...
func (s *SiteConfigService) GetUserSiteConfig(userID uint) (*models.ResellerProfile, *models.ResellerSiteConfig, bool, error) {
	...
	if profile == nil {
		return nil, nil, false, ErrNotOpened
	}
...
func (s *SiteConfigService) UpdateUserSiteConfig(ctx context.Context, userID uint, input ResellerSiteConfigInput) (*models.ResellerSiteConfig, error) {
...
func (s *SiteConfigService) ApplyPublicConfigOverlay(ctx context.Context, tenant TenantContext, base map[string]interface{}) (map[string]interface{}, error) {
