...
func NewOperationsService(store OperationsStore) *OperationsService {
...
func mapOperationsTopResellers(rows []OperationsTopResellerRow) []OperationsTopResellerResponse {
...
func buildOperationsAlerts(row OperationsOverviewRow) []OperationsAlertItem {
