...
func NewPostCategoryService(store PostCategoryStore) *PostCategoryService {
	return &PostCategoryService{store: store}
}

// ListAll 获取所有文章分类。
func (s *PostCategoryService) ListAll(ctx context.Context, parentID *uint) ([]models.PostCategory, error) {
	return s.store.ListAll(ctx, parentID)
}

// ListTree 获取全部分类树，包含禁用分类。
func (s *PostCategoryService) ListTree(ctx context.Context) ([]models.PostCategory, error) {
	return s.store.ListTree(ctx)
}

// GetByID 获取单个分类。
func (s *PostCategoryService) GetByID(ctx context.Context, id uint) (*models.PostCategory, error) {
...
// Create 创建文章分类。
func (s *PostCategoryService) Create(ctx context.Context, input CreatePostCategoryInput) (*models.PostCategory, error) {
...
// Update 更新文章分类。
func (s *PostCategoryService) Update(ctx context.Context, id uint, input CreatePostCategoryInput) (*models.PostCategory, error) {
...
// ListActive 获取所有激活分类。
func (s *PostCategoryService) ListActive(ctx context.Context) ([]models.PostCategory, error) {
	return s.store.ListActive(ctx)
}

// SetActive 切换分类启用状态。
func (s *PostCategoryService) SetActive(ctx context.Context, id uint, active bool) (*models.PostCategory, error) {
	category, err := s.GetByID(ctx, id)
	if err != nil {
		return nil, err
	}
...
func (s *PostCategoryService) validateParent(ctx context.Context, category *models.PostCategory, parentID *uint) error {
