...
func NewMediaService(store MediaStore, files FileStore, logger WarningLogger) *MediaService {
	return &MediaService{store: store, files: files, logger: logger}
}

// List 获取素材列表。
func (s *MediaService) List(ctx context.Context, query MediaListQuery) ([]models.Media, int64, error) {
	return s.store.List(ctx, MediaQuery{
		Page:     query.Page,
...
func (s *MediaService) RecordMedia(ctx context.Context, result UploadResult, scene string) (*models.Media, error) {
