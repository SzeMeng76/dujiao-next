...
func NewBannerService(store BannerStore, clock Clock) *BannerService {
	if clock == nil {
		clock = SystemClock{}
	}
...
func (s *BannerService) ListAdmin(ctx context.Context, query AdminBannerQuery) ([]models.Banner, int64, error) {
	return s.store.List(ctx, BannerQuery{
		Page:     query.Page,
...
func (s *BannerService) ListPublic(ctx context.Context, query PublicBannerQuery) ([]models.Banner, error) {
...
func (s *BannerService) GetByID(ctx context.Context, id string) (*models.Banner, error) {
...
// Create 创建 Banner。
func (s *BannerService) Create(ctx context.Context, input BannerInput) (*models.Banner, error) {
...
// Update 更新 Banner。
func (s *BannerService) Update(ctx context.Context, id string, input BannerInput) (*models.Banner, error) {
