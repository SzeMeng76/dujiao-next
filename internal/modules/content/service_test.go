...
func TestMediaServiceDeletesMetadataBeforeBestEffortFileRemoval(t *testing.T) {
	...
	store := &mediaStoreStub{
		media:  &models.Media{ID: 7, Path: "/uploads/post/image.png"},
		events: &events,
	}
...
var (
	_ PostStore                = (*postStoreStub)(nil)
	_ PostProductRelationStore = (*postStoreStub)(nil)
)

func (s *postStoreStub) List(context.Context, PostQuery) ([]models.Post, int64, error) {
	return nil, 0, nil
}
func (s *postStoreStub) WithinPostWriteTransaction(_ context.Context, operation func(PostStore, PostProductRelationStore) error) error {
	return operation(s, s)
}
func (s *postStoreStub) GetBySlug(context.Context, string, bool) (*models.Post, error) {
	return nil, nil
}
func (s *postStoreStub) GetByID(context.Context, string) (*models.Post, error) {
	return s.post, nil
}
func (s *postStoreStub) Create(_ context.Context, post *models.Post) error {
	post.ID = 1
	s.created = post
	return nil
}
func (s *postStoreStub) Update(context.Context, *models.Post) error { return nil }
...
var _ BannerStore = (*bannerStoreStub)(nil)

func (s *bannerStoreStub) List(context.Context, BannerQuery) ([]models.Banner, int64, error) {
	return nil, 0, nil
}
func (s *bannerStoreStub) ListValidByPosition(_ context.Context, position string, limit int, now time.Time) ([]models.Banner, error) {
	s.position = position
	s.limit = limit
	s.validAt = now
	return nil, nil
}
func (s *bannerStoreStub) GetByID(context.Context, string) (*models.Banner, error) {
	return nil, nil
}
func (s *bannerStoreStub) Create(context.Context, *models.Banner) error { return nil }
func (s *bannerStoreStub) Update(context.Context, *models.Banner) error { return nil }
...
var _ MediaStore = (*mediaStoreStub)(nil)

func (s *mediaStoreStub) List(context.Context, MediaQuery) ([]models.Media, int64, error) {
	return nil, 0, nil
}
func (s *mediaStoreStub) GetByID(context.Context, uint) (*models.Media, error) {
	return s.media, nil
}
func (s *mediaStoreStub) GetByPath(context.Context, string) (*models.Media, error) {
	return nil, nil
}
func (s *mediaStoreStub) Create(context.Context, *models.Media) error { return nil }
func (s *mediaStoreStub) Update(context.Context, *models.Media) error { return nil }
...
var _ FileStore = (*fileStoreStub)(nil)
...
var _ WarningLogger = (*warningLoggerStub)(nil)
