...
type AdminPostUseCases interface {
	ListAdmin(ctx context.Context, query domaincontent.AdminPostQuery) ([]models.Post, int64, error)
...
type AdminPostCategoryUseCases interface {
	...
	Create(ctx context.Context, input domaincontent.CreatePostCategoryInput) (*models.PostCategory, error)
	Update(ctx context.Context, id uint, input domaincontent.CreatePostCategoryInput) (*models.PostCategory, error)
	Delete(ctx context.Context, id uint) error
	SetActive(ctx context.Context, id uint, active bool) (*models.PostCategory, error)
}

// AdminBannerUseCases 是后台 Handler 实际需要的 Banner 能力。
type AdminBannerUseCases interface {
	ListAdmin(ctx context.Context, query domaincontent.AdminBannerQuery) ([]models.Banner, int64, error)
	GetByID(ctx context.Context, id string) (*models.Banner, error)
	Create(ctx context.Context, input domaincontent.BannerInput) (*models.Banner, error)
	Update(ctx context.Context, id string, input domaincontent.BannerInput) (*models.Banner, error)
	Delete(ctx context.Context, id string) error
}

// AdminMediaUseCases 是后台 Handler 实际需要的素材能力。
type AdminMediaUseCases interface {
	List(ctx context.Context, query domaincontent.MediaListQuery) ([]models.Media, int64, error)
...
func (h *AdminHandler) GetAdminMedia(c *gin.Context) {
	...
	items, total, err := h.media.List(c.Request.Context(), domaincontent.MediaListQuery{
		Scene:    c.Query("scene"),
		Search:   c.Query("search"),
		Page:     page,
		PageSize: pageSize,
