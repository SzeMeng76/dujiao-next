...
type publicPostQueriesStub struct {
	...
	receivedQuery   domaincontent.PublicPostQuery
}

var _ PublicPostQueries = (*publicPostQueriesStub)(nil)

func (s *publicPostQueriesStub) ListPublic(ctx context.Context, query domaincontent.PublicPostQuery) ([]models.Post, int64, error) {
	s.receivedContext = ctx
	s.receivedQuery = query
	return []models.Post{}, 0, nil
}

func (s *publicPostQueriesStub) GetPublicBySlug(context.Context, string) (*models.Post, error) {
...
type adminMediaUseCasesStub struct {
	receivedContext context.Context
	receivedQuery   domaincontent.MediaListQuery
}

var _ AdminMediaUseCases = (*adminMediaUseCasesStub)(nil)

func (s *adminMediaUseCasesStub) List(ctx context.Context, query domaincontent.MediaListQuery) ([]models.Media, int64, error) {
	s.receivedContext = ctx
	s.receivedQuery = query
