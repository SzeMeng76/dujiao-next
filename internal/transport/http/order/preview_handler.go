...
var userOrderCommonErrorRules = []mappedError{
	...
	{target: coupon.ErrInvalid, code: response.CodeBadRequest, key: "error.coupon_invalid"},
	{target: coupon.ErrNotFound, code: response.CodeBadRequest, key: "error.coupon_not_found"},
	{target: coupon.ErrInactive, code: response.CodeBadRequest, key: "error.coupon_inactive"},
	{target: coupon.ErrNotStarted, code: response.CodeBadRequest, key: "error.coupon_not_started"},
	{target: coupon.ErrExpired, code: response.CodeBadRequest, key: "error.coupon_expired"},
	{target: coupon.ErrUsageLimit, code: response.CodeBadRequest, key: "error.coupon_usage_limit"},
	{target: coupon.ErrPerUserLimit, code: response.CodeBadRequest, key: "error.coupon_per_user_limit"},
	{target: coupon.ErrMinAmount, code: response.CodeBadRequest, key: "error.coupon_min_amount"},
	{target: coupon.ErrScopeInvalid, code: response.CodeBadRequest, key: "error.coupon_scope_invalid"},
	{target: coupon.ErrPaymentRoleNotAllowed, code: response.CodeBadRequest, key: "error.coupon_payment_role_not_allowed"},
	{target: coupon.ErrPaymentRoleGuestOnly, code: response.CodeBadRequest, key: "error.coupon_payment_role_guest_only"},
