...
type productSettingStub struct {
	...
	rows   []models.ResellerProductSetting
	total  int64
	err    error
	saved  bool
}
...
func (s *productSettingStub) ListAdminSettings(input resellermodule.ProductSettingAdminListInput) ([]models.ResellerProductSetting, int64, error) {
...
func TestUserProductSettingHandlerMapsPricingError(t *testing.T) {
	...
	stub := &productSettingStub{err: resellermodule.ErrPriceBelowBase}
	h := NewUserProductSettingHandler(stub)
...
func TestUserProductSettingHandlerMapsInactiveProfile(t *testing.T) {
	gin.SetMode(gin.TestMode)
	stub := &productSettingStub{err: resellermodule.ErrProfileInactive}
	h := NewUserProductSettingHandler(stub)
...
func TestAdminProductSettingHandlerRecordsAuditOnSave(t *testing.T) {
	...
	audit := &auditStub{}
	h := NewAdminProductSettingHandler(stub, audit)
