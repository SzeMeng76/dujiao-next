...
type AdminManagementService interface {
	...
	RejectProfile(adminID, profileID uint, reason string) (*models.ResellerProfile, error)
	DisableProfile(adminID, profileID uint, reason string) (*models.ResellerProfile, error)
	RestoreProfile(adminID, profileID uint) (*models.ResellerProfile, error)
	UpdateProfileOperationalConfig(adminID, profileID uint, input resellermodule.ResellerProfileUpdateInput) (*models.ResellerProfile, error)
	AssignSystemSubdomain(ctx context.Context, adminID, profileID uint, input resellermodule.ResellerSystemDomainInput) (*models.ResellerDomain, error)
	ApproveDomain(ctx context.Context, adminID, domainID uint) (*models.ResellerDomain, error)
	DisableDomain(ctx context.Context, adminID, domainID uint) (*models.ResellerDomain, error)
	SetPrimaryDomain(ctx context.Context, adminID, domainID uint) (*models.ResellerDomain, error)
}
